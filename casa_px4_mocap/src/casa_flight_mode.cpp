...
public:
    ...
    {
        mode_publisher_ = this->create_publisher<std_msgs::msg::Int64>("/fmu/flight_mode",10);
//        uav_publisher_ = this->create_publisher<std_msgs::msg::Int64>("/fmu/uav_number",10);
...
private:
    ...
    void timer_callback()
    {
        auto flight_mode_msg = std_msgs::msg::Int64();
...
//        uav_publisher_->publish(uav_number_msg);
    ...
    rclcpp::Publisher<std_msgs::msg::Int64>::SharedPtr mode_publisher_;
