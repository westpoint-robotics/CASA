  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: gps_position_invalid
  {
    cdr << (ros_message->gps_position_invalid ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: gps_position_invalid
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->gps_position_invalid = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name gps_position_invalid
  {
    size_t item_size = sizeof(ros_message->gps_position_invalid);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name auto_mission_missing
