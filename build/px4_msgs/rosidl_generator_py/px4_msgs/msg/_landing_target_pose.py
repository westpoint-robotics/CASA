...
class LandingTargetPose(metaclass=Metaclass_LandingTargetPose):
    ...
    def x_rel(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'x_rel' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._x_rel = value
    ...
    def y_rel(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'y_rel' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._y_rel = value
    ...
    def z_rel(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'z_rel' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._z_rel = value
    ...
    def vx_rel(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'vx_rel' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._vx_rel = value
    ...
    def vy_rel(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'vy_rel' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._vy_rel = value
    ...
    def cov_x_rel(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'cov_x_rel' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def cov_y_rel(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'cov_y_rel' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def cov_vx_rel(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'cov_vx_rel' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def cov_vy_rel(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'cov_vy_rel' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def x_abs(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'x_abs' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._x_abs = value
    ...
    def y_abs(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'y_abs' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._y_abs = value
    ...
    def z_abs(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'z_abs' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._z_abs = value
