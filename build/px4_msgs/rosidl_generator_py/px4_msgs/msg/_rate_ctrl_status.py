...
class RateCtrlStatus(metaclass=Metaclass_RateCtrlStatus):
    ...
    def rollspeed_integ(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'rollspeed_integ' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def pitchspeed_integ(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'pitchspeed_integ' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def yawspeed_integ(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'yawspeed_integ' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def wheel_rate_integ(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'wheel_rate_integ' field must be a float in [-3.402823e+38, 3.402823e+38]"
