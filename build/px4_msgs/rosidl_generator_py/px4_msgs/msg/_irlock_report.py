...
class IrlockReport(metaclass=Metaclass_IrlockReport):
    ...
    def pos_x(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'pos_x' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._pos_x = value
    ...
    def pos_y(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'pos_y' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._pos_y = value
    ...
    def size_x(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'size_x' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._size_x = value
    ...
    def size_y(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'size_y' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._size_y = value
