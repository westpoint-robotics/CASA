...
class GimbalManagerInformation(metaclass=Metaclass_GimbalManagerInformation):
    ...
    def roll_min(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'roll_min' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def roll_max(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'roll_max' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def pitch_min(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'pitch_min' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def pitch_max(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'pitch_max' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def yaw_min(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'yaw_min' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._yaw_min = value
    ...
    def yaw_max(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'yaw_max' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._yaw_max = value
