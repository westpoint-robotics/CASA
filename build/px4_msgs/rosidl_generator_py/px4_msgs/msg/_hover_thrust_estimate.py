...
class HoverThrustEstimate(metaclass=Metaclass_HoverThrustEstimate):
    ...
    def hover_thrust(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'hover_thrust' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def hover_thrust_var(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'hover_thrust_var' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def accel_innov(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'accel_innov' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def accel_innov_var(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'accel_innov_var' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def accel_innov_test_ratio(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'accel_innov_test_ratio' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def accel_noise_var(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'accel_noise_var' field must be a float in [-3.402823e+38, 3.402823e+38]"
