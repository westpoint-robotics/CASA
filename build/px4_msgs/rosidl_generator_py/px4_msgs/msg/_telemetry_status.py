...
class TelemetryStatus(metaclass=Metaclass_TelemetryStatus):
    ...
    def data_rate(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'data_rate' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def rate_multiplier(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'rate_multiplier' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def tx_rate_avg(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'tx_rate_avg' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def tx_error_rate_avg(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'tx_error_rate_avg' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def rx_rate_avg(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'rx_rate_avg' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def rx_message_lost_rate(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'rx_message_lost_rate' field must be a float in [-3.402823e+38, 3.402823e+38]"
