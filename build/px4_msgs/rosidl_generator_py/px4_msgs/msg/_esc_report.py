...
class EscReport(metaclass=Metaclass_EscReport):
    ...
    def esc_voltage(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'esc_voltage' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def esc_current(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'esc_current' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def esc_temperature(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'esc_temperature' field must be a float in [-3.402823e+38, 3.402823e+38]"
