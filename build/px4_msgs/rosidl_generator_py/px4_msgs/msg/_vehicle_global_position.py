...
class VehicleGlobalPosition(metaclass=Metaclass_VehicleGlobalPosition):
    ...
    def alt_ellipsoid(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'alt_ellipsoid' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def delta_alt(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'delta_alt' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def terrain_alt(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'terrain_alt' field must be a float in [-3.402823e+38, 3.402823e+38]"
