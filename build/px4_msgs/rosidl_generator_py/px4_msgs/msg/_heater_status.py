...
class HeaterStatus(metaclass=Metaclass_HeaterStatus):
    ...
    def temperature_sensor(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'temperature_sensor' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def temperature_target(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'temperature_target' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def proportional_value(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'proportional_value' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def integrator_value(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'integrator_value' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def feed_forward_value(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'feed_forward_value' field must be a float in [-3.402823e+38, 3.402823e+38]"
