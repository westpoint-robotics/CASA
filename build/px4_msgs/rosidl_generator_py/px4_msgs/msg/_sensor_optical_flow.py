...
class SensorOpticalFlow(metaclass=Metaclass_SensorOpticalFlow):
    ...
    def pixel_flow(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'pixel_flow' field must be a set or sequence with length 2 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(val >= -3.402823e+38 and val <= 3.402823e+38 for val in value)), \
                "The 'delta_angle' field must be a set or sequence with length 3 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
    ...
    def distance_m(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'distance_m' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def max_flow_rate(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'max_flow_rate' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def min_ground_distance(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'min_ground_distance' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def max_ground_distance(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'max_ground_distance' field must be a float in [-3.402823e+38, 3.402823e+38]"
