...
class AutotuneAttitudeControlStatus(metaclass=Metaclass_AutotuneAttitudeControlStatus):
    ...
    def coeff(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'coeff' field must be a set or sequence with length 5 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(val >= -3.402823e+38 and val <= 3.402823e+38 for val in value)), \
                "The 'coeff_var' field must be a set or sequence with length 5 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
    ...
    def fitness(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'fitness' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._fitness = value
    ...
    def innov(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'innov' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._innov = value
    ...
    def dt_model(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'dt_model' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def kc(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'kc' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._kc = value
    ...
    def ki(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'ki' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._ki = value
    ...
    def kd(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'kd' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._kd = value
    ...
    def kff(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'kff' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._kff = value
    ...
    def att_p(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'att_p' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._att_p = value
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(val >= -3.402823e+38 and val <= 3.402823e+38 for val in value)), \
                "The 'rate_sp' field must be a set or sequence with length 3 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
    ...
    def u_filt(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'u_filt' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._u_filt = value
    ...
    def y_filt(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'y_filt' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._y_filt = value
