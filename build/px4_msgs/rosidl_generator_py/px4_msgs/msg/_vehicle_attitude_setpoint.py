...
class VehicleAttitudeSetpoint(metaclass=Metaclass_VehicleAttitudeSetpoint):
    ...
    def roll_body(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'roll_body' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def pitch_body(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'pitch_body' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def yaw_body(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'yaw_body' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def yaw_sp_move_rate(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'yaw_sp_move_rate' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def q_d(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'q_d' field must be a set or sequence with length 4 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(val >= -3.402823e+38 and val <= 3.402823e+38 for val in value)), \
                "The 'thrust_body' field must be a set or sequence with length 3 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
