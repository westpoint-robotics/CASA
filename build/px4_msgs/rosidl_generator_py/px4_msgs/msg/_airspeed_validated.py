...
class AirspeedValidated(metaclass=Metaclass_AirspeedValidated):
    ...
    def indicated_airspeed_m_s(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'indicated_airspeed_m_s' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def calibrated_airspeed_m_s(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'calibrated_airspeed_m_s' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def true_airspeed_m_s(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'true_airspeed_m_s' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def calibrated_ground_minus_wind_m_s(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'calibrated_ground_minus_wind_m_s' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def true_ground_minus_wind_m_s(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'true_ground_minus_wind_m_s' field must be a float in [-3.402823e+38, 3.402823e+38]"
