...
class VehicleCommand(metaclass=Metaclass_VehicleCommand):
    ...
    def param1(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'param1' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._param1 = value
    ...
    def param2(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'param2' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._param2 = value
    ...
    def param3(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'param3' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._param3 = value
    ...
    def param4(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'param4' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._param4 = value
    ...
    def param7(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'param7' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._param7 = value
