...
class NavigatorMissionItem(metaclass=Metaclass_NavigatorMissionItem):
    ...
    def latitude(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'latitude' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def longitude(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'longitude' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def time_inside(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'time_inside' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def altitude(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'altitude' field must be a float in [-3.402823e+38, 3.402823e+38]"
