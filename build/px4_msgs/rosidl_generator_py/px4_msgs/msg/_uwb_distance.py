    ...
    def aoafirst(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'aoafirst' field must be a set or sequence with length 12 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
