...
class CollisionReport(metaclass=Metaclass_CollisionReport):
    ...
    def time_to_minimum_delta(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'time_to_minimum_delta' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def altitude_minimum_delta(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'altitude_minimum_delta' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def horizontal_minimum_delta(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'horizontal_minimum_delta' field must be a float in [-3.402823e+38, 3.402823e+38]"
