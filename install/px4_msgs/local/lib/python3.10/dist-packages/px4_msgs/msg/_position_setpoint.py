...
class PositionSetpoint(metaclass=Metaclass_PositionSetpoint):
    ...
    def alt(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'alt' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._alt = value
    ...
    def loiter_radius(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'loiter_radius' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def cruising_speed(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'cruising_speed' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def cruising_throttle(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'cruising_throttle' field must be a float in [-3.402823e+38, 3.402823e+38]"
