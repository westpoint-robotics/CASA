...
class FollowTargetStatus(metaclass=Metaclass_FollowTargetStatus):
    ...
    def tracked_target_course(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'tracked_target_course' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def follow_angle(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'follow_angle' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def orbit_angle_setpoint(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'orbit_angle_setpoint' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def angular_rate_setpoint(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'angular_rate_setpoint' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def desired_position_raw(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'desired_position_raw' field must be a set or sequence with length 3 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
    ...
    def gimbal_pitch(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'gimbal_pitch' field must be a float in [-3.402823e+38, 3.402823e+38]"
