...
class VehicleRoi(metaclass=Metaclass_VehicleRoi):
    ...
    def roll_offset(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'roll_offset' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def pitch_offset(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'pitch_offset' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def yaw_offset(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'yaw_offset' field must be a float in [-3.402823e+38, 3.402823e+38]"
