...
class NpfgStatus(metaclass=Metaclass_NpfgStatus):
    ...
    def lat_accel(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'lat_accel' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def lat_accel_ff(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'lat_accel_ff' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def bearing_feas(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'bearing_feas' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def bearing_feas_on_track(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'bearing_feas_on_track' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def signed_track_error(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'signed_track_error' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def track_error_bound(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'track_error_bound' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def airspeed_ref(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'airspeed_ref' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def bearing(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'bearing' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._bearing = value
    ...
    def heading_ref(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'heading_ref' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def min_ground_speed_ref(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'min_ground_speed_ref' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def adapted_period(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'adapted_period' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def p_gain(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'p_gain' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._p_gain = value
    ...
    def time_const(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'time_const' field must be a float in [-3.402823e+38, 3.402823e+38]"
