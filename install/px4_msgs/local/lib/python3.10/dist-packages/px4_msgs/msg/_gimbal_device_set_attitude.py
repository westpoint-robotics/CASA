...
class GimbalDeviceSetAttitude(metaclass=Metaclass_GimbalDeviceSetAttitude):
    ...
    def angular_velocity_x(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'angular_velocity_x' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def angular_velocity_y(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'angular_velocity_y' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def angular_velocity_z(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'angular_velocity_z' field must be a float in [-3.402823e+38, 3.402823e+38]"
