...
class LandingTargetInnovations(metaclass=Metaclass_LandingTargetInnovations):
    ...
    def innov_x(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'innov_x' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._innov_x = value
    ...
    def innov_y(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'innov_y' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._innov_y = value
    ...
    def innov_cov_x(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'innov_cov_x' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def innov_cov_y(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'innov_cov_y' field must be a float in [-3.402823e+38, 3.402823e+38]"
