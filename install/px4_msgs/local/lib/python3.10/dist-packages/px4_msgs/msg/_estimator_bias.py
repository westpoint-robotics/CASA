...
class EstimatorBias(metaclass=Metaclass_EstimatorBias):
    ...
    def bias(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'bias' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._bias = value
    ...
    def bias_var(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'bias_var' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def innov_var(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'innov_var' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def innov_test_ratio(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'innov_test_ratio' field must be a float in [-3.402823e+38, 3.402823e+38]"
