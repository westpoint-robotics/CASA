...
class VehicleImuStatus(metaclass=Metaclass_VehicleImuStatus):
    ...
    def accel_rate_hz(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'accel_rate_hz' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def gyro_rate_hz(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'gyro_rate_hz' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def accel_raw_rate_hz(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'accel_raw_rate_hz' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def gyro_raw_rate_hz(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'gyro_raw_rate_hz' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def accel_vibration_metric(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'accel_vibration_metric' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def gyro_vibration_metric(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'gyro_vibration_metric' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def delta_angle_coning_metric(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'delta_angle_coning_metric' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def mean_accel(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'mean_accel' field must be a set or sequence with length 3 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(val >= -3.402823e+38 and val <= 3.402823e+38 for val in value)), \
                "The 'mean_gyro' field must be a set or sequence with length 3 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(val >= -3.402823e+38 and val <= 3.402823e+38 for val in value)), \
                "The 'var_accel' field must be a set or sequence with length 3 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, float) for v in value) and
                 all(val >= -3.402823e+38 and val <= 3.402823e+38 for val in value)), \
                "The 'var_gyro' field must be a set or sequence with length 3 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
    ...
    def temperature_accel(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'temperature_accel' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def temperature_gyro(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'temperature_gyro' field must be a float in [-3.402823e+38, 3.402823e+38]"
