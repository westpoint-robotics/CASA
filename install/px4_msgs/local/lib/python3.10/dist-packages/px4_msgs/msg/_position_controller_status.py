...
class PositionControllerStatus(metaclass=Metaclass_PositionControllerStatus):
    ...
    def nav_roll(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'nav_roll' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def nav_pitch(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'nav_pitch' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def nav_bearing(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'nav_bearing' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def target_bearing(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'target_bearing' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def xtrack_error(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'xtrack_error' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def wp_dist(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'wp_dist' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._wp_dist = value
    ...
    def acceptance_radius(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'acceptance_radius' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def yaw_acceptance(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'yaw_acceptance' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def altitude_acceptance(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'altitude_acceptance' field must be a float in [-3.402823e+38, 3.402823e+38]"
