...
class EstimatorGpsStatus(metaclass=Metaclass_EstimatorGpsStatus):
    ...
    def position_drift_rate_horizontal_m_s(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'position_drift_rate_horizontal_m_s' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def position_drift_rate_vertical_m_s(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'position_drift_rate_vertical_m_s' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def filtered_horizontal_speed_m_s(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'filtered_horizontal_speed_m_s' field must be a float in [-3.402823e+38, 3.402823e+38]"
