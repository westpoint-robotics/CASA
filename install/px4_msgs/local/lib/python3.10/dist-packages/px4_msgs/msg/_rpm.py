...
class Rpm(metaclass=Metaclass_Rpm):
    ...
    def indicated_frequency_rpm(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'indicated_frequency_rpm' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def estimated_accurancy_rpm(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'estimated_accurancy_rpm' field must be a float in [-3.402823e+38, 3.402823e+38]"
