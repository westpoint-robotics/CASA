...
class VehicleAirData(metaclass=Metaclass_VehicleAirData):
    ...
    def baro_alt_meter(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'baro_alt_meter' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def baro_temp_celcius(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'baro_temp_celcius' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def baro_pressure_pa(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'baro_pressure_pa' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def rho(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'rho' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._rho = value
