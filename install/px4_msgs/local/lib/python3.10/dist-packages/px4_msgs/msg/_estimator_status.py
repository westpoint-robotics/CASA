...
class EstimatorStatus(metaclass=Metaclass_EstimatorStatus):
    ...
    def output_tracking_error(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'output_tracking_error' field must be a set or sequence with length 3 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
    ...
    def pos_horiz_accuracy(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'pos_horiz_accuracy' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def pos_vert_accuracy(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'pos_vert_accuracy' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def mag_test_ratio(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'mag_test_ratio' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def vel_test_ratio(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'vel_test_ratio' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def pos_test_ratio(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'pos_test_ratio' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def hgt_test_ratio(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'hgt_test_ratio' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def tas_test_ratio(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'tas_test_ratio' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def hagl_test_ratio(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'hagl_test_ratio' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def beta_test_ratio(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'beta_test_ratio' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def time_slip(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'time_slip' field must be a float in [-3.402823e+38, 3.402823e+38]"
