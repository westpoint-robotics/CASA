    ...
    def voltage5v_v(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'voltage5v_v' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def sensors3v3(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'sensors3v3' field must be a set or sequence with length 4 and each value of type 'float' and each float in [-340282299999999994960115009090224128000.000000, 340282299999999994960115009090224128000.000000]"
