...
class GeneratorStatus(metaclass=Metaclass_GeneratorStatus):
    ...
    def battery_current(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'battery_current' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def load_current(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'load_current' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def power_generated(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'power_generated' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def bus_voltage(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'bus_voltage' field must be a float in [-3.402823e+38, 3.402823e+38]"
    ...
    def bat_current_setpoint(self, value):
        if __debug__:
            ...
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'bat_current_setpoint' field must be a float in [-3.402823e+38, 3.402823e+38]"
