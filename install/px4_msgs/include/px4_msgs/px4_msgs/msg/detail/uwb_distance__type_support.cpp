...
void fetch_function__UwbDistance__anchor_distance(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint16_t *>(
    get_const_function__UwbDistance__anchor_distance(untyped_member, index));
  auto & value = *reinterpret_cast<uint16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbDistance__anchor_distance(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint16_t *>(
    get_function__UwbDistance__anchor_distance(untyped_member, index));
...
void fetch_function__UwbDistance__nlos(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const bool *>(
    get_const_function__UwbDistance__nlos(untyped_member, index));
  auto & value = *reinterpret_cast<bool *>(untyped_value);
  value = item;
}

void assign_function__UwbDistance__nlos(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<bool *>(
    get_function__UwbDistance__nlos(untyped_member, index));
...
void fetch_function__UwbDistance__aoafirst(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__UwbDistance__aoafirst(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__UwbDistance__aoafirst(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__UwbDistance__aoafirst(untyped_member, index));
...
void fetch_function__UwbDistance__position(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const float *>(
    get_const_function__UwbDistance__position(untyped_member, index));
  auto & value = *reinterpret_cast<float *>(untyped_value);
  value = item;
}

void assign_function__UwbDistance__position(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<float *>(
    get_function__UwbDistance__position(untyped_member, index));
  const auto & value = *reinterpret_cast<const float *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UwbDistance_message_member_array[10] = {
  ...
  },
  {
    ...
    fetch_function__UwbDistance__anchor_distance,  // fetch(index, &value) function pointer
    assign_function__UwbDistance__anchor_distance,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "nlos",  // name
    ...
    fetch_function__UwbDistance__nlos,  // fetch(index, &value) function pointer
    assign_function__UwbDistance__nlos,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "aoafirst",  // name
    ...
    fetch_function__UwbDistance__aoafirst,  // fetch(index, &value) function pointer
    assign_function__UwbDistance__aoafirst,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "position",  // name
    ...
    fetch_function__UwbDistance__position,  // fetch(index, &value) function pointer
    assign_function__UwbDistance__position,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
