...
void fetch_function__UwbGrid__target_gps(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__UwbGrid__target_gps(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__target_gps(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__UwbGrid__target_gps(untyped_member, index));
...
void fetch_function__UwbGrid__target_pos(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__target_pos(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__target_pos(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__target_pos(untyped_member, index));
...
void fetch_function__UwbGrid__anchor_pos_0(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__anchor_pos_0(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__anchor_pos_0(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__anchor_pos_0(untyped_member, index));
  const auto & value = *reinterpret_cast<const int16_t *>(untyped_value);
  item = value;
}
...
void fetch_function__UwbGrid__anchor_pos_1(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__anchor_pos_1(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__anchor_pos_1(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__anchor_pos_1(untyped_member, index));
  const auto & value = *reinterpret_cast<const int16_t *>(untyped_value);
  item = value;
}
...
void fetch_function__UwbGrid__anchor_pos_2(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__anchor_pos_2(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__anchor_pos_2(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__anchor_pos_2(untyped_member, index));
  const auto & value = *reinterpret_cast<const int16_t *>(untyped_value);
  item = value;
}
...
void fetch_function__UwbGrid__anchor_pos_3(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__anchor_pos_3(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__anchor_pos_3(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__anchor_pos_3(untyped_member, index));
  const auto & value = *reinterpret_cast<const int16_t *>(untyped_value);
  item = value;
}
...
void fetch_function__UwbGrid__anchor_pos_4(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__anchor_pos_4(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__anchor_pos_4(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__anchor_pos_4(untyped_member, index));
  const auto & value = *reinterpret_cast<const int16_t *>(untyped_value);
  item = value;
}
...
void fetch_function__UwbGrid__anchor_pos_5(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__anchor_pos_5(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__anchor_pos_5(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__anchor_pos_5(untyped_member, index));
  const auto & value = *reinterpret_cast<const int16_t *>(untyped_value);
  item = value;
}
...
void fetch_function__UwbGrid__anchor_pos_6(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__anchor_pos_6(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__anchor_pos_6(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__anchor_pos_6(untyped_member, index));
  const auto & value = *reinterpret_cast<const int16_t *>(untyped_value);
  item = value;
}
...
void fetch_function__UwbGrid__anchor_pos_7(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__anchor_pos_7(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__anchor_pos_7(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__anchor_pos_7(untyped_member, index));
  const auto & value = *reinterpret_cast<const int16_t *>(untyped_value);
  item = value;
}
...
void fetch_function__UwbGrid__anchor_pos_8(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__anchor_pos_8(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__anchor_pos_8(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__anchor_pos_8(untyped_member, index));
  const auto & value = *reinterpret_cast<const int16_t *>(untyped_value);
  item = value;
}
...
void fetch_function__UwbGrid__anchor_pos_9(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__anchor_pos_9(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__anchor_pos_9(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__anchor_pos_9(untyped_member, index));
  const auto & value = *reinterpret_cast<const int16_t *>(untyped_value);
  item = value;
}
...
void fetch_function__UwbGrid__anchor_pos_10(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__anchor_pos_10(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__anchor_pos_10(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__anchor_pos_10(untyped_member, index));
  const auto & value = *reinterpret_cast<const int16_t *>(untyped_value);
  item = value;
}
...
void fetch_function__UwbGrid__anchor_pos_11(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const int16_t *>(
    get_const_function__UwbGrid__anchor_pos_11(untyped_member, index));
  auto & value = *reinterpret_cast<int16_t *>(untyped_value);
  value = item;
}

void assign_function__UwbGrid__anchor_pos_11(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<int16_t *>(
    get_function__UwbGrid__anchor_pos_11(untyped_member, index));
  const auto & value = *reinterpret_cast<const int16_t *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember UwbGrid_message_member_array[17] = {
  ...
  },
  {
    ...
    fetch_function__UwbGrid__target_gps,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__target_gps,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "target_pos",  // name
    ...
    fetch_function__UwbGrid__target_pos,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__target_pos,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "anchor_pos_0",  // name
    ...
    fetch_function__UwbGrid__anchor_pos_0,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__anchor_pos_0,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "anchor_pos_1",  // name
    ...
    fetch_function__UwbGrid__anchor_pos_1,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__anchor_pos_1,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "anchor_pos_2",  // name
    ...
    fetch_function__UwbGrid__anchor_pos_2,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__anchor_pos_2,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "anchor_pos_3",  // name
    ...
    fetch_function__UwbGrid__anchor_pos_3,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__anchor_pos_3,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "anchor_pos_4",  // name
    ...
    fetch_function__UwbGrid__anchor_pos_4,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__anchor_pos_4,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "anchor_pos_5",  // name
    ...
    fetch_function__UwbGrid__anchor_pos_5,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__anchor_pos_5,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "anchor_pos_6",  // name
    ...
    fetch_function__UwbGrid__anchor_pos_6,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__anchor_pos_6,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "anchor_pos_7",  // name
    ...
    fetch_function__UwbGrid__anchor_pos_7,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__anchor_pos_7,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "anchor_pos_8",  // name
    ...
    fetch_function__UwbGrid__anchor_pos_8,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__anchor_pos_8,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "anchor_pos_9",  // name
    ...
    fetch_function__UwbGrid__anchor_pos_9,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__anchor_pos_9,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "anchor_pos_10",  // name
    ...
    fetch_function__UwbGrid__anchor_pos_10,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__anchor_pos_10,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  },
  {
    "anchor_pos_11",  // name
    ...
    fetch_function__UwbGrid__anchor_pos_11,  // fetch(index, &value) function pointer
    assign_function__UwbGrid__anchor_pos_11,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
