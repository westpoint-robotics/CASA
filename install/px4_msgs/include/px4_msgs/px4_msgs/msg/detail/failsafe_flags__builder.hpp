...
class Init_FailsafeFlags_vtol_transition_failure
{
public:
  explicit Init_FailsafeFlags_vtol_transition_failure(::px4_msgs::msg::FailsafeFlags & msg)
  : msg_(msg)
  {}
  Init_FailsafeFlags_wind_limit_exceeded vtol_transition_failure(::px4_msgs::msg::FailsafeFlags::_vtol_transition_failure_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_FailsafeFlags_vtol_transition_failure mission_failure(::px4_msgs::msg::FailsafeFlags::_mission_failure_type arg)
  {
    msg_.mission_failure = std::move(arg);
    return Init_FailsafeFlags_vtol_transition_failure(msg_);
  }
